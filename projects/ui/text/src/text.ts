...
@Component({
  ...
  styles: `
    ...
    h1 { font-size: 2.5rem; font-weight: 700; line-height: 1.1; letter-spacing: var(--ui-tracking-tighter); }
    h2 { font-size: 1.875rem; font-weight: 700; line-height: 1.18; letter-spacing: var(--ui-tracking-tight); }
    h3 { font-size: 1.375rem; font-weight: 600; letter-spacing: var(--ui-tracking-tight); }
